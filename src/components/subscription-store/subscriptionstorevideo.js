...
function subscriptionvideo() {
  return (
    <div className={classes.subscriptionVideo}>
      ...
      <div
        className={
          classes.subscriptionBG + " mt-4 d-flex justify-content-around"
        }
      >
        <div className="d-flex justify-content-center align-items-center">
          <div className={classes.storeImg}>
            <a href="#" target="_blank">
              <img src={appstore} alt="subscription ad" className="img-fluid" />
            </a>
          </div>
        ...
        <div className="d-flex align-items-end justify-content-center h-100">
          <div className={classes.storePhoto}>
            <img src={img1} alt="subscription ad" className="img-fluid" />
          </div>
          <div className={classes.storePhoto}>
            <img src={img2} alt="subscription ad" className="img-fluid" />
          </div>
        </div>
      </div>
    </div>
